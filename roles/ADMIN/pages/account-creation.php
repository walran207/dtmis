...
$pageTitle = 'Account Management | DENR Region XII DTMIS';
$brandSubtitle = 'ICT Admin Portal';
$pageHeading = 'Account Management';
$pageSubtitle = 'Create, update, block, and delete local DTMIS user accounts inside your assigned scope.';
$activeMenu = 'account_management';
$showQueueTable = false;
$renderStandardContent = false;
$customSectionInclude = __DIR__ . '/sections/account-creation-panel.php';
