...
$profileRoleKey = app_normalize_role_key((string)($_SESSION['role_name'] ?? ''));
$isOredSigningAccount = $profileRoleKey === 'ORED_SIGN';

$menuItems = [
    ['key' => 'dashboard', 'label' => 'Executive Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['key' => 'rd_action_desk', 'label' => 'RD Action Desk', 'href' => 'rd-action-desk.php', 'icon' => 'signature'],
    ['key' => 'regional_reports', 'label' => 'Regional Summary Reports', 'href' => 'regional-summary-reports.php', 'icon' => 'report'],
    ['key' => 'audit_logs', 'label' => 'Audit Logs', 'href' => 'audit-logs.php', 'icon' => 'audit'],
    ['key' => 'global_search', 'label' => 'Global Search', 'href' => 'search-documents.php', 'icon' => 'search'],
    ['key' => 'profile_settings', 'label' => 'Profile Settings', 'href' => 'profile-settings.php', 'icon' => 'dashboard'],
];

if ($isOredSigningAccount) {
    array_splice($menuItems, 2, 0, [
        ['key' => 'digital_signature', 'label' => 'Digital Signature', 'href' => 'digital-signature.php', 'icon' => 'signature'],
        ['key' => 'path_diversion_override', 'label' => 'Path Diversion / Override', 'href' => 'path-diversion-override.php', 'icon' => 'override'],
    ]);
}
