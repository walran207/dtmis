...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'PENRO Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['key' => 'create_intake', 'label' => 'Create / Intake', 'href' => 'create-intake.php', 'icon' => 'create'],
    ['key' => 'document_type_requests', 'label' => 'Document Type Requests', 'href' => 'document-type-requests.php', 'icon' => 'audit'],
    ['type' => 'label', 'label' => 'Inbox'],
    ['key' => 'inbox_pending_receive', 'label' => 'Pending Receive', 'href' => 'pending-receive.php', 'icon' => 'inbox'],
    ['key' => 'inbox_returned_pacdo', 'label' => 'Returned from RECORDS-UNIT', 'href' => 'returned-pacdo.php', 'icon' => 'alert'],
    ['key' => 'audit_logs', 'label' => 'Audit Logs', 'href' => 'audit-logs.php', 'icon' => 'audit'],
    ['key' => 'reports', 'label' => 'Reports / Export', 'href' => 'reports-export.php', 'icon' => 'report'],
    ['key' => 'search', 'label' => 'Archive / Search', 'href' => 'search-documents.php', 'icon' => 'search'],
];
