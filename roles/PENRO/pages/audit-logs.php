...
$actedRows = [];
$actionTypes = ['Received', 'Approved', 'Forwarded', 'Returned', 'Released'];
$metrics = [
    'pending_total' => 0,
...
foreach ($actedRows as $row) {
    ...
    if (str_contains($actionType, 'receive')) {
        $receivedCount++;
    }
...
$pageHeading = 'PENRO Audit Logs';
$pageSubtitle = 'Documents you received, approved, and forwarded with current routing status.';
...
$kpiCards = [
    ['label' => 'Received by Me', 'icon' => 'blue', 'value' => (string)$receivedCount],
    ['label' => 'Approved by Me', 'icon' => 'green', 'value' => (string)$approvedCount],
...
$panels = [
    [
        'title' => 'PENRO Action Snapshot',
        'rows' => [
            ['label' => 'Received', 'value' => (string)$receivedCount, 'width' => '34%'],
...
$tableTitle = 'PENRO Action Tracker';
