...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'Division Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['key' => 'for_chief_action', 'label' => 'For Chief\'s Action', 'href' => 'for-chief-action.php', 'icon' => 'signature'],
    ...
    ['key' => 'adhoc_reroute', 'label' => 'Ad-Hoc Reroute', 'href' => 'adhoc-reroute.php', 'icon' => 'override'],
    ['key' => 'unit_report', 'label' => 'Unit Accomplishment Report / Export', 'href' => 'unit-accomplishment-report.php', 'icon' => 'report'],
