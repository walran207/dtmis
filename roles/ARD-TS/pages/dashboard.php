...
foreach ($queueRows as $queueRow) {
    $tableRows[] = [
        'value' => [
            ...
            'View Tracking Slip | Receive | Approve | Pending | Forward | Return | Reroute | Print Package',
        ],
        'meta' => [
...
$pageTitle = 'ARD TS Dashboard | DENR Region XII eDATS';
$brandSubtitle = 'ARD TS Portal';
$pageHeading = 'ARD TS Dashboard';
...
$pageActions = ['View Tracking Slip', 'Print Package', 'Receive', 'Approve', 'Pending', 'Forward', 'Return', 'Reroute'];
$stickyActions = ['Receive', 'Approve', 'Pending', 'Forward / Reroute', 'Return / Request Info', 'Print Slip', 'Print Package'];
