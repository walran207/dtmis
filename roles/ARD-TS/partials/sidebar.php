...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'ARD TS Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['key' => 'for_chief_action', 'label' => 'For ARD TS Action', 'href' => 'ard-ts-action.php', 'icon' => 'signature'],
    ['type' => 'label', 'label' => 'Unit Monitor'],
    ['key' => 'unit_monitor_with_staff', 'label' => 'With Division', 'href' => 'unit-monitor-with-staff.php', 'icon' => 'monitor'],
