...
$pageHeading = 'PENRO Admin Record Audit Logs';
...
$panels = [
    [
        'title' => 'PENRO Admin Record Action Snapshot',
        'rows' => [
    ...
    [
        ...
        'chips' => [
            'PENRO Admin Record -> PENRO Officer -> PENRO Division',
            'PENRO Division -> PENRO Section -> PENRO Division -> PENRO Admin Record',
            'PENRO Admin Record -> Complete or Forward to PENRO/PACDO',
        ],
    ],
];

$tableTitle = 'PENRO Admin Record Action Tracker';
