...
$activeMenuAliases = [
    'pacdo_action' => 'penro_admin_record_action',
    'branch_analytics' => 'penro_admin_record_analytics',
];
...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'PENRO Admin Record Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['key' => 'penro_admin_record_action', 'label' => 'PENRO Admin Record Action', 'href' => 'pacdo-action.php', 'icon' => 'checklist'],
    ['key' => 'action_stamp', 'label' => 'Action Stamp', 'href' => 'action-stamp.php', 'icon' => 'signature'],
    ['key' => 'create_intake', 'label' => 'Create / Intake', 'href' => 'create-intake.php', 'icon' => 'create'],
    ...
    ['key' => 'penro_admin_record_analytics', 'label' => 'Office Analytics', 'href' => 'branch-analytics.php', 'icon' => 'report'],
