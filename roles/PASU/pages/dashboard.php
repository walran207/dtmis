...
$pageTitle = 'PASU Dashboard | DENR Region XII eDATS';
$brandSubtitle = 'PASU Portal';
$pageHeading = 'PASU Dashboard';
...
$statCardNavigationTargets = [
    'default' => app_url('PASU/pending-receive.php'),
    'awaiting_receive' => app_url('PASU/pending-receive.php'),
    'received' => app_url('PASU/for-pasu-action.php'),
    'approved' => app_url('PASU/for-pasu-action.php'),
    'intake_drafts' => app_url('PASU/create-intake.php'),
];
