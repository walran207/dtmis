...
try {
    ...
    // Only docs returned to this PASU office by RECORDS-UNIT/ORED
...
$pageSubtitle = 'Documents sent back by RECORDS-UNIT/ORED to PASU for compliance corrections.';
...
$kpiCards = [
    ['label' => 'Returned to PASU', 'icon' => 'orange', 'value' => (string)$returnedCount],
