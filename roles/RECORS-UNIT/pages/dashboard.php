...
$pageTitle = 'RECORDS-UNIT Dashboard | DENR Region XII eDATS';
$brandSubtitle = 'RECORDS-UNIT Portal';
$pageHeading = 'RECORDS-UNIT Management Dashboard';
$pageSubtitle = 'Regional gatekeeping, clearance checks, and ARTA monitoring.';
