...
$roleName = 'CENRO';
$initialsFallback = 'CE';
$pageTitle = 'For CENRO Action | DENR Region XII eDATS';
$activeMenu = 'inbox_pending_receive';
$brandSubtitle = 'CENRO Portal';
$pageHeading = 'For CENRO Action';
$pageSubtitle = 'CENRO documents already received and awaiting action.';
...
$tableTitle = 'For CENRO Action Queue';
...
$notifications = json_decode('[{"title":"Queue updated","timeLabel":"Now","message":"For CENRO Action has a new routed document.","unread":true,"datetime":"2026-03-14T10:30:00"},{"title":"Tracking slip updated","timeLabel":"48m ago","message":"Custody timeline received a new event.","unread":true,"datetime":"2026-03-14T09:42:00"},{"title":"ARTA reminder","timeLabel":"2h ago","message":"Review due-soon and overdue items.","unread":false,"datetime":"2026-03-14T08:05:00"}]', true);
