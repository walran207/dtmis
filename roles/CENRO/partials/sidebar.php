...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'CENRO Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ...
    ['key' => 'inbox_returned_regional', 'label' => 'Returned from Regional', 'href' => 'returned-regional.php', 'icon' => 'alert'],
