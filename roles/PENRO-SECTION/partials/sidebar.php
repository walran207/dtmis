...
$activeMenuAliases = [
    'inbox_pending_receive' => 'cenro_unit_action',
    'outbox' => 'cenro_unit_outbox',
];
...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'PENRO Section Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['type' => 'label', 'label' => 'My Inbox'],
    ['key' => 'cenro_unit_action', 'label' => 'For Unit Action', 'href' => 'for-staff-action.php', 'icon' => 'inbox'],
    ['key' => 'cenro_unit_outbox', 'label' => 'My Outbox', 'href' => 'my-outbox.php', 'icon' => 'outbox'],
