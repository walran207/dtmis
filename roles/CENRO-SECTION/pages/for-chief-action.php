...
$pageSubtitle = 'CENRO section review queue for approval, return, and endorsement.';
...
$panels = [
    [
        'title' => 'CENRO Section Action Pending Mix',
        'rows' => [
...
$tableRows = json_decode('[{"value":["R12-DC-2026-001","For CENRO Section Action - Priority","Action Docket (Complex)","2026-03-14 07:55","2026-03-14 08:12","08h 20m","For Action","View | Receive | Approve | Forward | Reroute | Send Back to CENRO Officer"],"Count":8},{"value":["R12-DC-2026-002","For CENRO Section Action - Standard","Memo (Simple)","2026-03-13 10:30","2026-03-13 14:45","1d 04h","In Queue","View | Receive | Approve | Forward | Reroute | Send Back to CENRO Officer"],"Count":8},{"value":["R12-DC-2026-003","For CENRO Section Action - Returned","Request Info (Overdue)","2026-03-11 08:05","2026-03-11 09:10","Overdue by 1d","Urgent","View | Receive | Approve | Forward | Reroute | Send Back to CENRO Officer"],"Count":8}]', true);
$pageActions = json_decode('["Receive","Approve / Forward","Send Back to CENRO Officer"]', true);
$stickyActions = json_decode('["Receive","Approve","Forward","Send Back to CENRO Officer"]', true);
