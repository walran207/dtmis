...
$activeMenuAliases = [
    'for_chief_action' => 'cenro_section_action',
    'adhoc_reroute' => 'cenro_section_reroute',
    'unit_report' => 'cenro_section_unit_report',
];
...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'CENRO Section Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['key' => 'cenro_section_action', 'label' => 'For CENRO Section Action', 'href' => 'for-chief-action.php', 'icon' => 'signature'],
    ['key' => 'cenro_section_reroute', 'label' => 'Ad-Hoc Reroute', 'href' => 'adhoc-reroute.php', 'icon' => 'override'],
    ...
    ['key' => 'cenro_section_unit_report', 'label' => 'Unit Accomplishment Report / Export', 'href' => 'unit-accomplishment-report.php', 'icon' => 'report'],
