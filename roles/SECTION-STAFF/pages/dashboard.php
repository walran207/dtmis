...
foreach ($queueRows as $queueRow) {
    $tableRows[] = [
        'value' => [
            ...
            'View Tracking Slip | Receive | Pending | Forward | Return | Print Package',
        ],
        'meta' => [
...
$tableTitle = 'My Action Items (ARTA risk first)';
...
$pageActions = ['View Tracking Slip', 'Print Package', 'Receive', 'Pending', 'Forward', 'Return'];
$stickyActions = ['Receive', 'Pending', 'Forward / Reroute', 'Return / Request Info', 'Print Slip', 'Print Package'];
