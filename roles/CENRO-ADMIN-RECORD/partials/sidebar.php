...
$activeMenuAliases = [
    'pacdo_action' => 'cenro_admin_record_action',
    'branch_analytics' => 'cenro_admin_record_analytics',
];
...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'CENRO Admin Record Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['key' => 'cenro_admin_record_action', 'label' => 'CENRO Admin Record Action', 'href' => 'pacdo-action.php', 'icon' => 'checklist'],
    ...
    ['key' => 'cenro_admin_record_analytics', 'label' => 'Office Analytics', 'href' => 'branch-analytics.php', 'icon' => 'report'],
