...
try {
    ...
    $queueRows = dashboard_fetch_pending_receive_rows($pdo, $officeId, 100, true, true);
...
$pageTitle = 'CENRO Admin Record Action | DENR Region XII DTMIS';
...
$dashboardLivePath = app_url('actions/dashboard-live.php?scope=pending_receive_action&exclude_returned=1&limit=100');
