...
$activeMenuAliases = [
    'rd_action_desk' => 'cenro_officer_action_desk',
...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'CENRO Officer Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['key' => 'cenro_officer_action_desk', 'label' => 'CENRO Officer Action Desk', 'href' => 'rd-action-desk.php', 'icon' => 'signature'],
    ['key' => 'cenro_path_diversion_override', 'label' => 'Path Diversion / Override', 'href' => 'path-diversion-override.php', 'icon' => 'override'],
    ['key' => 'cenro_summary_reports', 'label' => 'CENRO Summary Reports', 'href' => 'regional-summary-reports.php', 'icon' => 'report'],
