...
$actedRows = [];
$actionTypes = ['Approved', 'Signed', 'Forwarded', 'Returned', 'Released', 'Overridden'];
...
foreach ($actedRows as $row) {
    ...
    if (str_contains($actionType, 'sign')) {
        $signedCount++;
    }
...
$pageHeading = 'CENRO Officer Action Tracker (Live)';
$pageSubtitle = 'Documents you approved/signed and their current routing position.';
...
$kpiCards = [
    ['label' => 'Signed by Me', 'icon' => 'green', 'value' => (string)$signedCount],
...
$panels = [
    [
        'title' => 'CENRO Officer Tracker Snapshot',
        'rows' => [
            ['label' => 'Signed', 'value' => (string)$signedCount, 'width' => '34%'],
...
$tableTitle = 'CENRO Officer Action Live Tracker';
