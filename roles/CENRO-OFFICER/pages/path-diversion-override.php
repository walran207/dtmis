...
$pageHeading = 'CENRO Officer Path Diversion';
$pageSubtitle = 'Dedicated reroute desk for CENRO Officer exception routing and bypass decisions.';
...
$panels = [
    [
        'title' => 'CENRO Officer Reroute Mix',
        'rows' => [
...
$tableTitle = 'CENRO Officer Reroute / Override';
...
$notifications = json_decode('[{"title":"Queue updated","timeLabel":"Now","message":"CENRO Officer reroute desk has a new routed document.","unread":true,"datetime":"2026-03-14T10:30:00"},{"title":"Tracking slip updated","timeLabel":"48m ago","message":"Custody timeline received a new event.","unread":true,"datetime":"2026-03-14T09:42:00"},{"title":"Reroute reminder","timeLabel":"2h ago","message":"Review bypass justification before submitting reroute.","unread":false,"datetime":"2026-03-14T08:05:00"}]', true);
