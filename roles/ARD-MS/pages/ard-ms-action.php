...
$roleName = 'ARD_MS';
$initialsFallback = 'AM';
$pageTitle = 'For ARD MS Action | DENR Region XII eDATS';
$activeMenu = 'for_chief_action';
$brandSubtitle = 'ARD MS Portal';
$pageHeading = 'For ARD MS Action';
$pageSubtitle = 'ARD MS review queue for approval, division assignment, and escalation.';
...
$panels = [
    [
        'title' => 'ARD MS Action Pending Mix',
        'rows' => [
...
$tableRows = json_decode('[{"value":["R12-DC-2026-001","For ARD MS Action - Priority","Action Docket (Complex)","2026-03-14 07:55","2026-03-14 08:12","08h 20m","For Action","View | Receive | Approve | Forward | Send Back to ARD | Reroute"],"Count":8},{"value":["R12-DC-2026-002","For ARD MS Action - Standard","Memo (Simple)","2026-03-13 10:30","2026-03-13 14:45","1d 04h","In Queue","View | Receive | Approve | Forward | Send Back to ARD | Reroute"],"Count":8},{"value":["R12-DC-2026-003","For ARD MS Action - Returned","Request Info (Overdue)","2026-03-11 08:05","2026-03-11 09:10","Overdue by 1d","Urgent","View | Receive | Approve | Forward | Send Back to ARD | Reroute"],"Count":8}]', true);
...
$notifications = json_decode('[{"title":"Queue updated","timeLabel":"Now","message":"For ARD MS Action has a new routed document.","unread":true,"datetime":"2026-03-14T10:30:00"},{"title":"Tracking slip updated","timeLabel":"48m ago","message":"Custody timeline received a new event.","unread":true,"datetime":"2026-03-14T09:42:00"},{"title":"ARTA reminder","timeLabel":"2h ago","message":"Review due-soon and overdue items.","unread":false,"datetime":"2026-03-14T08:05:00"}]', true);
