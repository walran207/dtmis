...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'ARD MS Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['key' => 'for_chief_action', 'label' => 'For ARD MS Action', 'href' => 'ard-ms-action.php', 'icon' => 'signature'],
