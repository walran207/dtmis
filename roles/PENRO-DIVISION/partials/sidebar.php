...
$activeMenuAliases = [
    'for_chief_action' => 'penro_division_action',
    'adhoc_reroute' => 'penro_division_reroute',
    'unit_report' => 'penro_division_unit_report',
];
$activeMenuKey = $activeMenuAliases[$activeMenuKey] ?? $activeMenuKey;
...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'PENRO Division Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['key' => 'penro_division_action', 'label' => 'For PENRO Division Action', 'href' => 'for-chief-action.php', 'icon' => 'signature'],
    ['key' => 'penro_division_reroute', 'label' => 'Ad-Hoc Reroute', 'href' => 'adhoc-reroute.php', 'icon' => 'override'],
    ['type' => 'label', 'label' => 'Unit Monitor'],
    ['key' => 'unit_monitor_with_staff', 'label' => 'With Staff', 'href' => 'unit-monitor-with-staff.php', 'icon' => 'monitor'],
    ['key' => 'unit_monitor_overdue', 'label' => 'Overdue / At-Risk', 'href' => 'unit-monitor-overdue.php', 'icon' => 'alert'],
    ['key' => 'penro_division_unit_report', 'label' => 'Unit Accomplishment Report / Export', 'href' => 'unit-accomplishment-report.php', 'icon' => 'report'],
