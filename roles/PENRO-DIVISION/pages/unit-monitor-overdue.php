...
$panels = [
    ...
    [
        ...
        'chips' => ['Prioritize overdue first', 'Validate current holder', 'Escalate long-running delays', 'Forward resolved items'],
    ],
];
...
$tableRows = json_decode('[{"value":["R12-DC-2026-001","Unit Monitor (Overdue / At-Risk) - Priority","Action Docket (Complex)","PENRO Division","2026-03-14 08:12","08h 20m","For Action","View | Receive | Forward"],"Count":8},{"value":["R12-DC-2026-002","Unit Monitor (Overdue / At-Risk) - Standard","Memo (Simple)","PENRO Division","2026-03-13 14:45","1d 04h","In Queue","View | Forward"],"Count":8},{"value":["R12-DC-2026-003","Unit Monitor (Overdue / At-Risk) - Returned","Request Info (Overdue)","PENRO Division","2026-03-11 09:10","Overdue by 1d","Urgent","View | Receive | Forward"],"Count":8}]', true);
$pageActions = json_decode('["Monitor","Assign","Forward"]', true);
$stickyActions = json_decode('["Forward"]', true);
