...
$pageHeading = 'PENRO Division Ad-Hoc Reroute';
$pageSubtitle = 'Pull routed documents and reroute to appropriate PENRO Section with documented reason.';
...
$panels = [
    [
        'title' => 'PENRO Division Reroute Queue Mix',
        'rows' => [
    ...
    [
        ...
        'chips' => ['Pull from queue before reroute', 'Set clear reroute reason', 'Confirm target PENRO Section', 'Capture remarks for audit trail'],
    ],
];
...
$notifications = json_decode('[{"title":"Queue updated","timeLabel":"Now","message":"PENRO Division reroute desk has a new routed document.","unread":true,"datetime":"2026-03-14T10:30:00"},{"title":"Tracking slip updated","timeLabel":"48m ago","message":"Custody timeline received a new event.","unread":true,"datetime":"2026-03-14T09:42:00"},{"title":"Reroute reminder","timeLabel":"2h ago","message":"Validate reroute reason before submitting.","unread":false,"datetime":"2026-03-14T08:05:00"}]', true);
