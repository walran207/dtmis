...
$pageHeading = 'PAMO Admin Audit Logs';
...
$panels = [
    [
        'title' => 'PAMO Admin Action Snapshot',
        'rows' => [
    ...
    [
        ...
        'chips' => [
            'PAMO Admin -> PASU -> PAMO Unit',
            'PAMO Unit -> PASU -> PAMO Admin',
            'PAMO Admin -> Complete or Forward to CENRO/PENRO',
        ],
    ],
];

$tableTitle = 'PAMO Admin Action Tracker';
