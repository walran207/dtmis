...
$pageHeading = 'PASU Path Diversion';
$pageSubtitle = 'Dedicated reroute desk for PASU exception routing and bypass decisions.';
...
$panels = [
    ...
    [
        ...
        'chips' => ['Unit first by default', 'Bypass reason required', 'Confirm destination office', 'Capture remarks for audit trail'],
    ],
];
$tableTitle = 'PASU Reroute / Override';
...
$notifications = json_decode('[{"title":"Queue updated","timeLabel":"Now","message":"PASU reroute desk has a new routed document.","unread":true,"datetime":"2026-03-14T10:30:00"},{"title":"Tracking slip updated","timeLabel":"48m ago","message":"Custody timeline received a new event.","unread":true,"datetime":"2026-03-14T09:42:00"},{"title":"Reroute reminder","timeLabel":"2h ago","message":"Review bypass justification before submitting reroute.","unread":false,"datetime":"2026-03-14T08:05:00"}]', true);
