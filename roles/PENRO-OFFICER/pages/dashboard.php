...
$pageTitle = 'PENRO Officer Dashboard | DENR Region XII eDATS';
$brandSubtitle = 'PENRO Officer Portal';
$pageHeading = 'PENRO Officer Dashboard';
$pageSubtitle = 'PENRO officer action, approvals, and strict internal routing.';
$activeMenu = 'dashboard';
$tableTitle = 'PENRO Officer Action Desk (ARTA risk first)';
