...
$pageSubtitle = 'PENRO workload and completion performance across internal offices.';
...
$notifications = [
    [
        'title' => 'PENRO summary synced',
        'timeLabel' => 'Now',
        'message' => 'PENRO office summary has been refreshed from live records.',
        'unread' => true,
        'datetime' => date('c'),
    ],
];
