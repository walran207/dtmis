...
$activeMenuAliases = [
    'rd_action_desk' => 'penro_officer_action_desk',
    'path_diversion_override' => 'cenro_path_diversion_override',
    'regional_reports' => 'cenro_summary_reports',
];
...
$menuItems = [
    ['key' => 'dashboard', 'label' => 'PENRO Officer Dashboard', 'href' => 'dashboard.php', 'icon' => 'dashboard'],
    ['key' => 'penro_officer_action_desk', 'label' => 'PENRO Officer Action Desk', 'href' => 'rd-action-desk.php', 'icon' => 'signature'],
    ['key' => 'cenro_path_diversion_override', 'label' => 'Path Diversion / Override', 'href' => 'path-diversion-override.php', 'icon' => 'override'],
    ['key' => 'cenro_summary_reports', 'label' => 'PENRO Summary Reports', 'href' => 'regional-summary-reports.php', 'icon' => 'report'],
